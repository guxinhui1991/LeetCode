...
# Dec 27, 2023
# Dynamic programming --
# dp[i] : length of longest increase sequence, ending with nums[i]
#
#
################################################################################################
class Solution5:
...
print(Solution5().lengthOfLIS([10,9,2,5,3,7,101,18]))
print(Solution5().lengthOfLIS(nums = [1,5,6,2,3,4]))
print(Solution5().lengthOfLIS([7,7,7,7,7,7,7,7]))